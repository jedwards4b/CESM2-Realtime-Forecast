...
;    infile='domain.T62.050609.nc'
    infile='domain.lnd.360x720_cruncep.130305.nc'
    id=ncdf_open(infile)
...
;infile = "./T62_NCEP_CFSv2_dims.nc"
infile = "./NCEP_CFSv2_0.2d_dims.nc"
...
outfile=dir+'domain.ncepCFSv2.c2019.0.2d.nc'

;--  reverse orientation to south -> north  ------------------------
; my data are already ordered south to north
...
NCDF_ATTPUT, id, /GLOBAL, 'case_title', $
  'NCEPCFSv2 6-Hourly Atmospheric Forcing'  
