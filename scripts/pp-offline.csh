...
setenv CASEROOT /glade/scratch/nanr/comet-smyle/
setenv ARCHDIR /glade/scratch/jedwards/smyle-comet/archive/
...
if ($mbr < 10) then
        set CASE = b.e21.BSMYLE-ERA5.f09_g17.${year}-${mon}.00${mbr}
else
        set CASE = b.e21.BSMYLE-ERA5.f09_g17.${year}-${mon}.0${mbr}
endif
...
pp_config --set DOUT_S_ROOT=$ARCHDIR/$CASE
...
mpirun singularity run -B /glade,/var /glade/work/bdobbins/Containers/CESM_Postprocessing/image /opt/ncar/cesm_postprocessing/cesm-env2/bin/cesm_tseries_generator.py  --caseroot /glade/scratch/nanr/comet-smyle/b.e21.BSMYLE-ERA5.f09_g17.${year}-${mon}.${usembr}/postprocess >> ./logs/timeseries.`date +%Y%m%d-%H%M%S`
