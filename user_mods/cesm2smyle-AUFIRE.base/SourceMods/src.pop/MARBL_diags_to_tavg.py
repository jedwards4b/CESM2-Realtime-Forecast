...
def _parse_args():
    ...
    parser.add_argument('--midhigh_frequency_stream', action='store', dest='midhigh_frequency_stream',
                        type=int, default= 0, help='Stream to put medium-high frequency output into (required if not lMARBL_tavg_all)')
...
if __name__ == "__main__":
    ...
    frequency_dict['midhigh'] = args.midhigh_frequency_stream
