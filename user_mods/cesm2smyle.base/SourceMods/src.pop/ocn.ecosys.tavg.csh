...
@ s4 = 4             # use the base-model stream 4
...
# Look in SourceMod for MARBL_diags_to_tavg.py
# Otherwise use version in POP source code
if ( -f $CASEROOT/SourceMods/src.pop/MARBL_diags_to_tavg.py ) then
