...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%jconvect_col       (begc:endc))           ; this%jconvect_col       (:)   = nan
  ...
  subroutine InitHistory(this, bounds)
    ...
    if (use_lch4) then
       this%jconvect_col(begc:endc) = spval
       call hist_addfld1d (fname='JCONVECT', units='unitless', &
            avgflag='A', long_name='lowest lake level where convection occurs', &
            ptr_col=this%jconvect_col, set_nolake=spval)
    end if
