...
CLIENT_ID = '36709e83-a476-4a3c-b52e-0ce503b983bb'
...
def get_globus_transfer_data_struct(client, token=None):
    home = os.environ.get("HOME")
...
#    auth_code = "xXsY1Ul1x7c6t9vgUUvcxtdxrlWLW8"
...
def get_endpoint_id(transfer_client, endpoint_name):
    for ep in  transfer_client.endpoint_search(endpoint_name):
        return ep['id']
