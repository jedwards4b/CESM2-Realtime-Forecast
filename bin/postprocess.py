...
_LIBDIR = os.path.join("/home/smyle/work/cesm/cesm2.1.4-SMYLE/cime", "scripts", "Tools")
...
#run_cmd("./pp_config --set TIMESERIES_OUTPUT_ROOTDIR={}/timeseries/{}".format(caseroot,os.getenv("SMYLE_ROOT")),from_dir="postprocess",verbose=True)
...
expect(os.path.isdir("./postprocess"),"postprocess dir NOT created! Die!! {} ".format(caseroot))
