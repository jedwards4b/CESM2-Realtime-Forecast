...
#    dest_path = '/gpfs/csfs1/cesm/development/cross-wg/S2S/'
    ...
    dest_path = '/glade/p/datashare/ssfcst/cesm2cam6climoLNDv2/'
...
def _main_func(description):
    ...
    basecasename = "cesm2cam6climoLND"
...
#                os.unlink(_file)
        ...
        outdir = "/glade/scratch/ssfcst/cesm2cam6climoLNDv2/ice"
        ...
        outdir = "/glade/scratch/ssfcst/cesm2cam6climoLNDv2/ocn"

        for _file in glob.iglob(os.path.join(ocnhistpath,"*pop.h.*.nc")):
            newfname = os.path.basename(_file).replace("cesm2cam6climoLND.","cesm2cam6climoLNDv2.")
            run_cmd("nccopy -4 -d 1 {}  {}".format(_file, os.path.join(outdir,newfname)), verbose=True, from_dir=ocnhistpath)


        outdir = "/glade/scratch/ssfcst/cesm2cam6climoLNDv2/6hourly"
        ...
        outdir = "/glade/scratch/ssfcst/cesm2cam6climoLNDv2/daily"
...
#            run_cmd("nccopy -4 -d 1 -VU10,TGCLDIWP,TGCLDLWP,lev,ilev,lat,lon,date,time_bnds,time,gw,ndcur,nscur,nsteph {} {}".format(_file, os.path.join(outdir,os.path.basename(_file))), verbose=True, from_dir=atmhistpath)
        ...
        outdir = "/glade/scratch/ssfcst/cesm2cam6climoLNDv2/lnd/"
