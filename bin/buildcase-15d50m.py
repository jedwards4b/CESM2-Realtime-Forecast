...
#    case.set_value("DOUT_S_ROOT",dout_s_root)
    ...
    for usermod in glob.iglob(user_mods_dir+"/15d50m/user*"):
...
def tbi_mod_pop(caseroot,date):
    ...
    PTINTMASKFILE = "/glade/work/yeager/cesm_runs/cesm2.x_B_cases/CLIVAR_TBI_hindcastpacemaker/data/TBI_Atlantic_mask_10S-10N_taper10.nc"
...
def _main_func(description):
    ...
    basecasename = "b.e21.BSMYLE.f09_g17.TBI-ATL_15d50m-anom"
